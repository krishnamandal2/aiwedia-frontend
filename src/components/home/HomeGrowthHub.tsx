...
const FEATURES = [
  ...
  },
  {
    href: "/stacks",
    title: "AI Stacks",
    desc: "SEO, vibe coding, startup & creator workflows — tools + prompts + news.",
    icon: Layers,
  ...
  },
  {
    ...
    desc: "ChatGPT, Midjourney, Copilot alternatives — SEO lists.",
    icon: GitCompare,
    accent: "from-indigo-600 to-violet-600",
  },
  {
    href: "/deals",
    title: "AI deals & discounts",
    desc: "Lifetime deals, student pricing, and startup API credits.",
    icon: Trophy,
    accent: "from-amber-500 to-orange-600",
  },
  {
    ...
    desc: "Best for students, coding, video, startups & free tools.",
    icon: Layers,
    accent: "from-fuchsia-600 to-pink-600",
  },
  {
    href: "/collections/best-ai-tools-for-students",
    title: "Best for students",
    desc: "Study-friendly AI with free tiers and edu discounts.",
    icon: Sparkles,
